  ...
  if (event->type() == QEvent::KeyPress)
    {
      ...
      if (key == Qt::Key_V && readFromBuffer())
        {
      ...
      if (key >= Qt::Key_0 && key <= Qt::Key_9)
        {
          QChar a   = char ('0' + (key - Qt::Key_0));
          label->commiting += a;
          QString t = label->commiting;

          //qDebug() << QString ("input:keypress:number:a:") + a + ":key:" + key + ":t:" + t;
