...
CheckBox {
    ...
    property string checkboxOn: "qrc:/horizontalMode/Resources/" + pathTheme + "/icons/other/ic_checkbox_on.png"
    property string checkboxOff: "qrc:/horizontalMode/Resources/" + pathTheme + "/icons/other/ic_checkbox_off.png"
