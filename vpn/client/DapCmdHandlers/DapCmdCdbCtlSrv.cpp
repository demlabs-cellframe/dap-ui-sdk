...
const QString DapCmdCdbCtlSrv::s_fieldCdb =
  DapJsonParams::toString (DapJsonParams::CDB);

const QString DapCmdCdbCtlSrv::s_fieldValue =
...
DapCmdCdbCtlSrv::DapCmdCdbCtlSrv (QObject *parent)
...
void DapCmdCdbCtlSrv::sendCmdGetList (const QString &a_value)
{
...
void DapCmdCdbCtlSrv::handle (const QJsonObject *a_params)
{
  /* get value and check */
