#include "DapCmdSendBugReportSrv.h"


DapCmdSendBugReportSrv::DapCmdSendBugReportSrv(QObject *parent)
    : DapCmdServiceAbstract (DapJsonCmdType::SEND_BUG_REPORT, parent)
{
    connect(this, &DapCmdSendBugReportSrv::sigSendCmdBugReportAnswer, [=](const QString& number){
        QJsonObject obj;
...
DapCmdSendBugReportSrv::~DapCmdSendBugReportSrv()
{

}

void DapCmdSendBugReportSrv::handle(const QJsonObject *params)
{
    Q_UNUSED(params);
