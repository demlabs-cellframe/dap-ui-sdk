...
void DapCmdServersListSrv::sendRequestToCDB(){
...
void DapCmdServersListSrv::updateServerList(const QJsonArray& arr)
{
...
bool DapCmdServersListSrv::loadServerList()
{
    QJsonArray arr;
    QString time;
...
void DapCmdServersListSrv::sendServerList(const QJsonArray& arr, const QString &time)
{
    QJsonObject obj;
    obj["servers"] = arr;
