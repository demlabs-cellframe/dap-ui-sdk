#include "DapCmdStatsSrv.h"

DapCmdStatsSrv::DapCmdStatsSrv(QObject *parent) :
    DapCmdServiceAbstract(DapJsonCmdType::STATS, parent)
{

}

void DapCmdStatsSrv::handle(const QJsonObject* params)
{
    Q_UNUSED(params);
...
void DapCmdStatsSrv::sendCmdStats(qint64 readBytes, qint64 writeBytes,
