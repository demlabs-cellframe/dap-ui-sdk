...
static const QVector<Item> s_items =
{
  ...
  {
    "Are the IP addresses output by KelVPN residential or stored on the server?",
    "In the current testnet, the addresses used are not residential (do not belong to the users of the network). NoCBD mode is under development. When it is deployed, users will have the opportunity to use KelVPN in a decentralized mode, utilizing residential addresses offered by other users. Or they can continue to use normal mode, as they wish."
  },
  {
    "When will KelVPN be available on Playstore or F-Droid?",
    "The team is working on publishing KelVPN on Google Play. You can see this in the current roadmap. Stay tuned for updates!"
  },
  {
    "Is there a free trial?",
    "No, not at the moment. The 3-day trial period feature is under development and its release is on our nearest development roadmap."
  },
  {
    "I don't have access to the device where I used KelVPN last time. How can I reset my license key without it?",
    "Right now, the only way to reset it is through our support team. Resetting and restoring keys using a seed phrase is one of the upcoming features on our development roadmap."
  },
};
