...
void DapCmdNode::slotStartSearchOrders()
{
  ...
  searchOrders["unit"]          = unit;
  searchOrders["min_price"]     = QString::number (minPrice); //_data->minPrice;
  searchOrders["max_price"]     = QString::number (maxPrice); //_data->maxPrice;
